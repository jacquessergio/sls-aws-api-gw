...
var PgConnection_1 = require("../config/PgConnection");
var APIDao = /** @class */ (function () {
    function APIDao() {
    }
    APIDao.prototype.query = function (revisionId) {
        return __awaiter(this, void 0, void 0, function () {
            var client, sql, rows, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, PgConnection_1.default.connect()];
                    case 1:
                        client = _a.sent();
